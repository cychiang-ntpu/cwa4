...
✓ = PDF 落在 ours mean ± 2σ 內（已用程式重算驗證）。
- 13 個熱中心站、31 個有 PDF 數字的 cell（13 站 × 3 cell - 8 缺值），**12/31 (39%) cell 在 ±2σ 內**。
...
- **逐格 PDF↔ours 比對**：12/31 (39%) cell 在 mean ± 2σ 內，比 M4 的 70% 低，原因是 M3 std 普遍很小 (0.01-0.06)，所以 ±2σ 區間窄，更難涵蓋差異。
